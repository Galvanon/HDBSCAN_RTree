...
rt.Index_GetReads.argtypes = [ctypes.c_void_p]
rt.Index_GetReads.restype = ctypes.c_uint64
rt.Index_GetReads.errcheck = check_value  # type: ignore

rt.Index_GetWrites.argtypes = [ctypes.c_void_p]
rt.Index_GetWrites.restype = ctypes.c_uint64
rt.Index_GetWrites.errcheck = check_value  # type: ignore

rt.Index_GetNumberOfNodes.argtypes = [ctypes.c_void_p]
rt.Index_GetNumberOfNodes.restype = ctypes.c_uint32
rt.Index_GetNumberOfNodes.errcheck = check_value  # type: ignore

rt.Index_GetNumberOfData.argtypes = [ctypes.c_void_p]
rt.Index_GetNumberOfData.restype = ctypes.c_uint64
rt.Index_GetNumberOfData.errcheck = check_value  # type: ignore

rt.Index_GetSplits.argtypes = [ctypes.c_void_p]
rt.Index_GetSplits.restype = ctypes.c_uint64
rt.Index_GetSplits.errcheck = check_value  # type: ignore

rt.Index_GetHits.argtypes = [ctypes.c_void_p]
rt.Index_GetHits.restype = ctypes.c_uint64
rt.Index_GetHits.errcheck = check_value  # type: ignore

rt.Index_GetMisses.argtypes = [ctypes.c_void_p]
rt.Index_GetMisses.restype = ctypes.c_uint64
rt.Index_GetMisses.errcheck = check_value  # type: ignore

rt.Index_GetAdjustments.argtypes = [ctypes.c_void_p]
rt.Index_GetAdjustments.restype = ctypes.c_uint64
rt.Index_GetAdjustments.errcheck = check_value  # type: ignore

rt.Index_GetQueryResults.argtypes = [ctypes.c_void_p]
rt.Index_GetQueryResults.restype = ctypes.c_uint64
rt.Index_GetQueryResults.errcheck = check_value  # type: ignore

rt.Index_GetTreeHeight.argtypes = [ctypes.c_void_p]
rt.Index_GetTreeHeight.restype = ctypes.c_uint32
rt.Index_GetTreeHeight.errcheck = check_value  # type: ignore

rt.Index_GetNumberOfNodesInLevel.argtypes = [
    ctypes.c_void_p,
    ctypes.c_uint32,
    ctypes.POINTER(ctypes.c_uint32),
]
rt.Index_GetNumberOfNodesInLevel.restype = ctypes.c_int  # RTError
#rt.Index_GetNumberOfNodesInLevel.errcheck = check_return  # type: ignore

rt.IndexProperty_SetBulkLoadMethod.argtypes = [ctypes.c_void_p, ctypes.c_uint32]
rt.IndexProperty_SetBulkLoadMethod.restype = ctypes.c_int
rt.IndexProperty_SetBulkLoadMethod.errcheck = check_return # type: ignore

rt.IndexProperty_GetBulkLoadMethod.argtypes = [ctypes.c_void_p]
rt.IndexProperty_GetBulkLoadMethod.restype = ctypes.c_uint32
rt.IndexProperty_GetBulkLoadMethod.errcheck = check_value # type: ignore